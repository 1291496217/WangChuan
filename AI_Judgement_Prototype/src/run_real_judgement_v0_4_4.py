...
from prompt_builder_v0_4_4 import PROMPT_VERSION, build_prompt_v0_4_4
from run_real_judgement_versioned import run_one_versioned

SCHEMA_VERSION = "0.2"
CORRECTION_STAGE = "Week8 Day6 Selected-Key De-Anchoring Correction"
...
def run_one(*, report_id: str, results_root: Path, confirm: bool = False) -> int:
    return run_one_versioned(
        ...
        prompt_builder=build_prompt_v0_4_4,
        language_auditor=audit_game_language_v0_2,
    )


def main() -> int:
    parser = argparse.ArgumentParser(description="One controlled Prompt v0.4.4 de-anchoring regression call")
    parser.add_argument("--report-id", required=True)
    parser.add_argument("--results", type=Path, default=Path("results/week8b_prompt044_root_cause_regression"))
