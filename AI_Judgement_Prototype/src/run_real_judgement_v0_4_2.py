...
from prompt_builder_v0_4_2 import PROMPT_VERSION, build_prompt_v0_4_2
...
SCHEMA_VERSION = "0.2"
CORRECTION_STAGE = "Week8 Day6 Revised Micro-Correction"
...
def run_one(*, report_id: str, results_root: Path, confirm: bool = False) -> int:
    ...
    messages = build_prompt_v0_4_2(case_data=case_data, judge_data=judge_data, player_report=report, schema_data=schema)
    if not confirm:
...
def main() -> int:
    parser = argparse.ArgumentParser(description="One controlled Prompt v0.4.2 micro-correction regression call")
    parser.add_argument("--report-id", required=True)
    parser.add_argument("--results", type=Path, default=Path("results/week8b_prompt042_micro_regression"))
