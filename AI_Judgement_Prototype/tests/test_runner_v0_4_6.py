...
from run_real_judgement_v0_4_6 import CORRECTION_STAGE, SCHEMA_VERSION  # noqa: E402
from run_real_judgement_versioned import publication_allowed  # noqa: E402


class RunnerV046Tests(unittest.TestCase):
    def test_identity(self):
        self.assertEqual(CORRECTION_STAGE, "Week8 Day6 Strict Visible-World Correction")
        self.assertEqual(SCHEMA_VERSION, "0.2")

    def test_warning_is_not_publishable(self):
    ...
    def test_no_key_literal(self):
        text = (ROOT / "src/run_real_judgement_v0_4_6.py").read_text(encoding="utf-8")
